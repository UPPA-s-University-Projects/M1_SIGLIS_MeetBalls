...
public interface IMsgDao {
	...
	public Msg createMessage(Msg m, final boolean useTransac);
	public Msg updateMessage(Msg m, final boolean useTransac);
	public void deleteMessage(Msg m, final boolean useTransac);
}
