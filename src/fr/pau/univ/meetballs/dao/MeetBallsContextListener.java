...
//Cette classe permet de créer un contextListener. Elle utilise un Servlet, et permet donc de s'occuper du côté
...
@WebListener
public class MeetBallsContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        final EntityManagerFactory emf = Persistence.createEntityManagerFactory("MeetBalls");
